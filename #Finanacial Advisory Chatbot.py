...
openai.api_key = 'API_KEY'  #I have removed my key from here, please add your api key from (https://help.openai.com/en/articles/4936850-where-do-i-find-my-secret-api-key) website
